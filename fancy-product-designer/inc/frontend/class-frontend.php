			...
			if( $product_settings->show_designer() ) {
				...
				$configs = array(
					...
					'misc'	=> array(
						...
						'pro_export_enabled' 		=> class_exists('Fancy_Product_Designer_Export')
					),
					'labels' => array(
					...
					'app_options' 	=> [
						...
						'imageSizeTooltip' => fpd_get_option('fpd_imageSizeTooltip'),
						...
						'fabricCanvasOptions' => [
							...
							'perPixelTargetFind' => fpd_get_option('fpd_canvas_per_pixel_detection'),
						],
						'qrCodeProps' => [
						...
						'enableDynamicViews' => $product_settings->get_option('enableDynamicViews'),
						'dynamicViewsOptions' => [
