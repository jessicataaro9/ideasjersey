		...
		Totals.prototype.calculate = function() {
			...
			this.$addons.each( function () {
				...
				if (
					...
					// se agrega funcinalidad de replicar cantidad del addons hacia la cantidad de productos sergio rf 
					var qqTy = $( '.wc-pao-addon-input-multiplier' ).val();
				        $(".e-atc-qty-button-holder .quantity input[name='quantity']").val(qqTy);

			    	if(qqTy) {
					    self.qty = parseInt(qqTy);
				    }
